...
var line = cljs.core.get.call(null,map__26203__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__26203__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e26202){var _e = e26202;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___26205 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___26205)){
var seen_errors_26206 = temp__5455__auto___26205;
if(cljs.core.truth_(seen_errors_26206.has(self))){
} else {
seen_errors_26206.add(self);

var temp__5457__auto___26207 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___26207)){
var sense_26208 = temp__5457__auto___26207;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_26208)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1543016396753
