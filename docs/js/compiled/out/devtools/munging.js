...
var o24228 = temp__5455__auto__;
var temp__5455__auto____$1 = (o24228["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o24229 = temp__5455__auto____$1;
return (o24229["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__23332__auto__ = f;
return (o__23332__auto__["toString"]).call(o__23332__auto__);
} else {
return "";
}
}catch (e24230){var _ = e24230;
return "";
}});
...
try{var o__23332__auto___24232 = t;
(o__23332__auto___24232["cljs$lang$ctorPrWriter"]).call(o__23332__auto___24232,t,writer);
}catch (e24231){var __24233 = e24231;
}
...
var char_code = (function (){var o__23332__auto__ = (new String(char$));
return (o__23332__auto__["charCodeAt"]).call(o__23332__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__23332__auto__ = String;
return (o__23332__auto__["fromCharCode"]).call(o__23332__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24234 = num_code;
switch (G__24234) {
case (1):
return (185);
...
var o__23332__auto__ = String;
return (o__23332__auto__["fromCharCode"]).call(o__23332__auto__,superscript_code);
});
/**
...
}catch (e24236){var _e__23339__auto__ = e24236;
return false;
}})())){
...
var vec__24237 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__24237,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o24240 = temp__5455__auto__;
var temp__5455__auto____$1 = (o24240["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o24241 = temp__5455__auto____$1;
return (o24241["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24244){
var vec__24245 = p__24244;
var ns_detector = cljs.core.nth.call(null,vec__24245,(0),null);
...
var G__24251 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__24252 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__24251;
remaining_tokens = G__24252;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24242){
var G__24243 = cljs.core.first.call(null,seq24242);
var seq24242__$1 = cljs.core.next.call(null,seq24242);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24243,seq24242__$1);
});
...
var vec__24256 = cljs.core.split_with.call(null,(function (p1__24255_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24255_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__24256,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__24256,(1),null);
...
var vec__24259 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__24259,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__24259,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__24262 = cljs.core.rest.call(null,remaining_tokens);
var G__24263 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__24262;
name_tokens = G__24263;
continue;
} else {
...
var vec__24266 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__24266,(0),null);
var arity = cljs.core.nth.call(null,vec__24266,(1),null);
var vec__24269 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__24269,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__24269,(1),null);
var vec__24272 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__24272,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__24272,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__24272,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__24272,(3),null);
...
var vec__24278 = result;
var munged_ns = cljs.core.nth.call(null,vec__24278,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__24278,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__24278,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__24278,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__24278,(4),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__24282 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__24282,(0),null);
var args = cljs.core.nth.call(null,vec__24282,(1),null);
var vec__24285 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__24285,(0),null);
var name = cljs.core.nth.call(null,vec__24285,(1),null);
...
var G__24288 = (arity + (1));
var G__24289 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24290){
var vec__24291 = p__24290;
var arity = cljs.core.nth.call(null,vec__24291,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__24291,(1),null);
...
return cljs.core.get.call(null,arities,p1__24294_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__24295_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24298){
var vec__24299 = p__24298;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__24299,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24296){
var G__24297 = cljs.core.first.call(null,seq24296);
var seq24296__$1 = cljs.core.next.call(null,seq24296);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24297,seq24296__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__24307__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__24307__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__24307__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__24307__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24308 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__24308,(0),null);
var fn_name = cljs.core.nth.call(null,vec__24308,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__24308,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__24308,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__24308,(4),null);
var arity = cljs.core.nth.call(null,vec__24308,(5),null);
...
var o__23332__auto__ = f;
return (o__23332__auto__["getBasis"]).call(o__23332__auto__);
});
/**
...
}catch (e24312){var _e__23339__auto__ = e24312;
...
var G__24313 = (obj[cljs.core.first.call(null,path)]);
var G__24314 = cljs.core.rest.call(null,path);
obj = G__24313;
path = G__24314;
continue;
} else {
...
return (function (accum,p__24315){
var vec__24316 = p__24315;
var bit = cljs.core.nth.call(null,vec__24316,(0),null);
var protocol = cljs.core.nth.call(null,vec__24316,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24319){
var vec__24320 = p__24319;
var ns = cljs.core.nth.call(null,vec__24320,(0),null);
var name = cljs.core.nth.call(null,vec__24320,(1),null);
var selector = cljs.core.nth.call(null,vec__24320,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__24325,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__24325,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__24325,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__24323_SHARP_){
return (obj[cljs.core.first.call(null,p1__24323_SHARP_)]);
});})(name,sorted_matches,vec__24325,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1543016389238
